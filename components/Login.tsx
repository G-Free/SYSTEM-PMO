  ...
  return (
    <div className="min-h-screen bg-sga-bg flex font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-900">
        ...
        ></div>
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-sga-bg via-slate-900/90 to-sga-brand/30 z-10"></div>
        ...
        <div className="relative z-20 flex flex-col justify-end p-16 h-full text-white">
          <div className="mb-6">
            <div className="h-50 w-50 bg-white p-8 rounded-xl flex items-center justify-center shadow-6xl shadow-white/50 mb-10">
              <img src={Sgalogotipo} alt="" />
              <img src={Sgalogotipo} alt="SGA Logo" className="h-12" />
            </div>
